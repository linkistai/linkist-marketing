...
export const FEATURES: readonly FeaturePage[] = [
  ...
  },
  {
    ...
    tabs: [
      { key: 'search', title: 'Natural-Language Search', body: 'Type what you remember: the fintech founder from GITEX, the designer who mentioned Riyadh. Linkist searches names, notes and context together.', screen: 'v6-contacts', kind: 'phone', alt: 'Natural-Language Search screen' },
      { key: 'icp', title: 'ICP Matching', body: 'Describe your ideal customer, partner or hire once. Linkist shows which contacts fit and how many strong matches you already have.', screen: 'v6-icpdetail', kind: 'phone', alt: 'ICP Matches screen', plan: 'Pro' },
      { key: 'priority', title: 'Relationship Priority', body: 'Relationship Health shows who is warming up, cooling down and cold, so attention goes where it is needed.', screen: 'v6-health', kind: 'phone', alt: 'Relationship Health screen' },
  ...
  },
  {
    ...
    name: 'Act',
    stage: 'Act and grow',
    title: 'Act: Top Actions, nudges, introductions and follow-up',
    ...
    tabs: [
      { key: 'top', title: 'Top Actions', body: 'The most important things to do today, on the home screen, ordered by what deserves attention.', screen: 'v6-home', kind: 'phone', alt: 'Top Actions on the home screen', plan: 'Pro' },
      { key: 'nudges', title: 'Intelligent Nudges and Smart Signals', body: 'You met Julian at GITEX. Want to follow up? A nudge arrives before the moment passes, and signals tell you what changed.', screen: 'v6-brief', kind: 'phone', alt: 'A nudge card', plan: 'Pro' },
  ...
  },
  {
    ...
    stage: 'Capture and share',
    title: 'Profiles and cards: your live digital business card',
    ...
    tabs: [
      ...
      { key: 'share', title: 'Sharing and wallet', body: 'Share by NFC tap, QR code, link, email or SMS, and add the card to Apple Wallet or Google Wallet.', screen: 'v6-share', kind: 'phone', alt: 'Share Contact screen' },
    ],
  ...
  },
  {
    ...
    name: 'Teams',
    stage: 'Act and grow',
    title: 'Teams: shared contacts that stay with the company',
