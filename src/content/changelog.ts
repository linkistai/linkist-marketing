...
export const CHANGELOG: readonly Change[] = [
  ...
  },
  {
    date: '2026-09-07',
    tag: 'Legal',
    title: 'Linkist Terms and Privacy, version 1.0',
    items: [
      'One plain-language document for the Essential, Enhanced, Pro and Teams plans replaces all earlier terms of service and privacy policies: a short version, key words, Part 1 the terms of use in 20 sections, Part 2 privacy in 16.',
      'AI features are off until switched on, every result shows its confidence, and no AI decision seriously affects people. Paid plans renew automatically with 30 days\' notice of price changes; payments already made are not refunded except in three listed cases. The Teams plan sets out roles, team versus personal contacts, and what happens when a team ends.',
    ],
    source: 'Documents supplied by RatioX Labs DWC-LLC, reproduced at /legal/terms and /legal/privacy',
  },
  {
    date: '2026-06-01',
    tag: 'Legal',
