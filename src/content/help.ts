...
export const HELP: readonly HelpEntry[] = [
  ...
  e('NFC cards and shipping', 'What is printed on a Signature NFC card?', 'Your name and logo. The terms list names, titles, company details, logos, colours and QR codes as the content a custom card can carry, and you are responsible for it being accurate and yours to use.', [TERMS]),
  ...
  e('NFC cards and shipping', 'Does the NFC card work with every phone?', 'It needs a phone with NFC switched on. The terms say NFC depends on compatible devices, settings, operating system restrictions and correct use, and do not guarantee every device. Cards can also carry a QR code as a fallback.', [TERMS]),
  ...
  e('NFC cards and shipping', 'Can I use an NFC card or sticker I already own?', 'Yes, free. At nfctools.linkist.ai, tap the card or sticker on your phone and Linkist writes your live profile onto it, or paste an existing profile link and your Linkist profile builds itself. Encoding a chip needs an Android phone; the profile then works on every device.'),
