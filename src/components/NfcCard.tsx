...
export function NfcCard({ material, tier, name, meta, className = '', sizes = '(min-width: 640px) 420px, 80vw', priority = false }: { material: Finish; tier: 'starter' | 'signature' | 'founders'; name?: string; meta?: string; className?: string; sizes?: string; priority?: boolean }) {
...
export function NfcCardBack({ material, sizes = '(min-width: 640px) 420px, 80vw' }: { material: Finish; sizes?: string }) {
  return (
