...
const TRUTH: readonly HelpEntry[] = [
  ...
  { id: 'truth-lifetime', category: 'Plans and billing', q: 'Is there a lifetime plan or a one-time price?', a: 'Not at the moment. Enhanced, Pro and Team are paid monthly or yearly, and Essential is free. Launch offers, a one-time price among them, show on the pricing page while they run.', links: [{ label: 'Pricing', href: '/pricing' }] },
