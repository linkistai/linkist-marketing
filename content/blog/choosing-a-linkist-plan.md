...
The plans answer four different questions, and the right one is the question you are asking this month. Prices below are in US dollars with UAE dirhams in brackets, as listed on the pricing page; the store checks out cards in AED.
...
A card is one-time: Starter from AED 75 and Signature from AED 95, in PVC, cherry wood or brushed metal, each including PRM Essential. The Signature Bundle pairs any Signature card with a year of Pro for AED 369 ($100); the Founders Circle Bundle pairs the Founders Circle card with lifetime Pro for AED 549 ($150). Both cost less than the card and Pro bought separately; the [bundles page](/bundles) shows the arithmetic by material.
