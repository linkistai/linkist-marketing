---json
{
  ...
  "cover": "/blog/what-is-relationship-capital/cover.jpg",
  "coverAlt": "What Is Relationship Capital, and Why Is It a Business Asset?",
  "source": "https://www.linkist.ai/blogs/what-is-relationship-capital",
  "imported": "2026-09-10",
  "faq": [
    {
      "q": "What is relationship capital?",
      "a": "Relationship capital is the value created through professional relationships built on trust, credibility, context, access and reciprocity. It reflects not merely who you know, but the strength and usefulness of the relationships within your network."
    },
    {
      "q": "Is relationship capital the same as social capital?",
      "a": "The concepts overlap. Social capital is a broader academic and social concept describing value created through networks, trust and shared norms. Relationship capital is commonly used in a professional or business context to describe the value held within specific relationships."
    },
    {
      "q": "How does relationship capital create business value?",
      "a": "It can support trusted introductions, referrals, faster collaboration, access to expertise, better information and greater resilience during periods of change."
    },
    {
      "q": "Can relationship capital be measured?",
      "a": "It cannot be reduced to a single perfect score. However, indicators such as relationship strength, interaction history, relevance, responsiveness, reciprocity and network diversity can help professionals understand the health of their network."
    },
    {
      "q": "What is the difference between a contact and a relationship?",
      "a": "A contact record tells you how to reach someone. A relationship includes context, history, trust, relevance and a reason for continued interaction."
    },
    {
      "q": "How does Linkist help manage relationship capital?",
      "a": "Linkist combines professional identity sharing with relationship memory, notes, context, contact organisation, prioritisation, trusted pathways and follow-up support. It is designed to help users remember who they met, why the person matters and what action should happen next."
    },
    {
      "q": "Does a PRM replace a CRM?",
      "a": "Not necessarily. A CRM is generally organised around customers, accounts, transactions and sales pipelines. A PRM focuses more broadly on the people in a professional network, the context behind those relationships and the actions that help maintain them."
    },
    {
      "q": "Can teams share relationship capital responsibly?",
      "a": "Yes, when information is shared with clear permissions, appropriate access controls and respect for personal and professional boundaries. The goal should be continuity and collaboration, not surveillance."
    }
  ]
}
---
...
Relationship capital is the value created through professional relationships built on trust, credibility, context, access and reciprocity. It reflects not merely who you know, but the strength and usefulness of the relationships within your network.

### Is relationship capital the same as social capital?
The concepts overlap. Social capital is a broader academic and social concept describing value created through networks, trust and shared norms. Relationship capital is commonly used in a professional or business context to describe the value held within specific relationships.

### How does relationship capital create business value?
It can support trusted introductions, referrals, faster collaboration, access to expertise, better information and greater resilience during periods of change.

### Can relationship capital be measured?
It cannot be reduced to a single perfect score. However, indicators such as relationship strength, interaction history, relevance, responsiveness, reciprocity and network diversity can help professionals understand the health of their network.

### What is the difference between a contact and a relationship?
A contact record tells you how to reach someone. A relationship includes context, history, trust, relevance and a reason for continued interaction.

### How does Linkist help manage relationship capital?
Linkist combines professional identity sharing with relationship memory, notes, context, contact organisation, prioritisation, trusted pathways and follow-up support. It is designed to help users remember who they met, why the person matters and what action should happen next.

### Does a PRM replace a CRM?
Not necessarily. A CRM is generally organised around customers, accounts, transactions and sales pipelines. A PRM focuses more broadly on the people in a professional network, the context behind those relationships and the actions that help maintain them.

### Can teams share relationship capital responsibly?
Yes, when information is shared with clear permissions, appropriate access controls and respect for personal and professional boundaries. The goal should be continuity and collaboration, not surveillance.
