...
1. **Hero (D50).** Eyebrow "Personal Relationship Manager", the three-line headline "Capture contacts. Remember context. Follow up at the right time." with the third line in coral, the lede "Linkist is the AI-powered PRM that turns the people you meet into relationships you keep. Save contacts in seconds, get timely nudges, and never lose track of who matters — with or without an NFC card.", two equal buttons ("Create Free Profile" to the app's unified sign-in, "Get Linkist NFC" to the card product's sign-in), the line "Free to start · No NFC card required · Add one any time" centred under them, a hairline, the App Store and Google Play badges (inert and "Coming soon" until the listings exist, R3) and "Already have an NFC card? Bring your own" to the NFC tools site. On the right, the composite product scene badged "Design preview": the prototype's home screen on a phone, a black Linkist card standing beside it, a plain white card mid-tap. No switcher, no carousel, no proof strip; the owner's words are used as supplied, em dash included.
