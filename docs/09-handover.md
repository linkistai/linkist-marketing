...
- **Legal.** Terms v1.2 and Privacy v1.3 came as Word files (`../legal/`, outside the repo) and are converted by `pnpm legal:docx <file> <terms|privacy>`; the front matter carries `supplied` instead of `source`. Citations on /ai and /security were renumbered to match.
